  ...
  <div class="wrapper">
        ...
        <nav id="sidebar" class ="active" style="box-shadow:2px 2px 7px rgba(206,206,206,0.5);">
            ...
            <ul class="list-unstyled components">
                <li <?php if(!isset($_POST['keywordtype'])) {echo "class='active'";} ?>>
            ...
            <?php
                ...
                while($row = $result->fetch_array()){ ?>
                    <li <?php if(isset($_POST['keywordtype']) && $_POST['keywordtype']==$row['tag_name']) {echo "class='active'";} ?>>
                ...
                $result = $mysqli->query($q);
                while($row = $result->fetch_array()){ ?>
                    <form id="my_form<?=$row['id']?>" style="display:inline-block;" action="product.php" method="POST" >
                        <input type="hidden" name="keywordtype" value="<?=$row['tag_name']?>">
                    </form>
                    <?php
                } ?>
              <!-- <li <?php if(isset($_POST['keywordtype']) && $_POST['keywordtype']=='Strategic') {echo "class='active'";} ?>>
                <form id="my_form2" action="product.php" method="POST">
                <input type="hidden" name="keywordtype" value="Strategic">
                <a href="javascript:{}" onclick="document.getElementById('my_form2').submit();">Strategy</a>
              </form></li>
              <li <?php if(isset($_POST['keywordtype']) && $_POST['keywordtype']=='Deck Building') {echo "class='active'";} ?>>
                <form id="my_form3" action="product.php" method="POST">
                <input type="hidden" name="keywordtype" value="Deck Building">
                <a href="javascript:{}" onclick="document.getElementById('my_form3').submit();">Deck Building</a>
              </form></li>
              <li <?php if(isset($_POST['keywordtype']) && $_POST['keywordtype']=='Thematic') {echo "class='active'";} ?>>
                <form id="my_form4" action="product.php" method="POST">
                <input type="hidden" name="keywordtype" value="Thematic">
                <a href="javascript:{}" onclick="document.getElementById('my_form4').submit();">Thematic</a>
              </form></li>
              <li <?php if(isset($_POST['keywordtype']) && $_POST['keywordtype']=='Abstract') {echo "class='active'";} ?>>
                <form id="my_form5" action="product.php" method="POST">
                <input type="hidden" name="keywordtype" value="Abstract">
                <a href="javascript:{}" onclick="document.getElementById('my_form5').submit();">Abstract</a>
              </form></li>
              <li <?php if(isset($_POST['keywordtype']) && $_POST['keywordtype']=='Family') {echo "class='active'";} ?>>
                <form id="my_form6" action="product.php" method="POST">
                <input type="hidden" name="keywordtype" value="Family">
                <a href="javascript:{}" onclick="document.getElementById('my_form6').submit();">Family</a>
              </form></li> -->
            </ul>
        </nav>
...
elseif (isset($_POST['keywordtype'])) {
  $keyword=$_POST['keywordtype'];
      ...
      ?>
          <div class="col-sm-3">
              <div class="panel panel-primary text-center">
                  ...
                  ?>
                  <form action="product.php#<?=$rowcount?>" method="POST">
      ...
      <nav aria-label="page navigation">
        <ul class="pagination">
          ...
          if($_SESSION['curppage']!='1'){ //================= prev button ======================= ?>
            <li>
              <form id="prev" action="product.php" method="post" style="display:inline-block;">
          ...
          for($i = 1; $i <= $count ; $i++){ //======================== number button ================= ?>
            <form id="page<?= $i ?>" action="product.php" method="post" style="display:inline-block;">
          ...
          if($_SESSION['curppage']!=$_SESSION['ppagelast']){ //=================== Next button ============= ?>
            <li>
              <form id="next" action="product.php" method="post" style="display:inline-block;">
                  <input type="hidden" name="page" value="<?= ((int)$_SESSION['curppage'])+1 ?>">
                  <?php
                  if(isset($_POST['keyword'])){
                    $keyword=$_POST['keyword']; ?>
