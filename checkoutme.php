...
<div class="container-fluid text-center">
  <div class="row content">
      ...
      $sql="SELECT * FROM product WHERE product_id IN (";
                  ...
                  ?>
                      <tr <?php if($quantitycheck==false) echo 'style="background:rgba(255, 213, 213,.4);"'; ?>>
                          ...
                          <td class="text-left" style="vertical-align:middle;"><?php echo $row['product_name'] ?>
    ...
    <table align="center">
      <tr>
          <td>Your address:&nbsp;</td>
          <td><textarea rows="4" cols="40" class="form-control" id="comment" name="address" placeholder="Please insert your address here..." form="purchase" required></textarea></td>
      </tr>
    </table>
      <br>
